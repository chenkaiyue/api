...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrioritySelector) DeepCopyInto(out *PrioritySelector) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrioritySelector.
func (in *PrioritySelector) DeepCopy() *PrioritySelector {
	if in == nil {
		return nil
	}
	out := new(PrioritySelector)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceQOSSpec) DeepCopyInto(out *ServiceQOSSpec) {
	*out = *in
	...
	if in.PrioritySelectors != nil {
		...
		*out = make([]PrioritySelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
