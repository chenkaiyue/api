...
func (in *QOSEnsurance) DeepCopyInto(out *QOSEnsurance) {
	*out = *in
	...
	if in.LowestPriorityCpuLimit != nil {
		in, out := &in.LowestPriorityCpuLimit, &out.LowestPriorityCpuLimit
		*out = make([]lowestPriorityCpuLimit, len(*in))
		copy(*out, *in)
	}
	if in.LowestPriorityCpuLimitPeriod != nil {
		in, out := &in.LowestPriorityCpuLimitPeriod, &out.LowestPriorityCpuLimitPeriod
		*out = make([]lowestPriorityCpuLimitPeriod, len(*in))
		copy(*out, *in)
	}
	return
}
