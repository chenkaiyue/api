...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrioritySelectorRequirement) DeepCopyInto(out *PrioritySelectorRequirement) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrioritySelectorRequirement.
func (in *PrioritySelectorRequirement) DeepCopy() *PrioritySelectorRequirement {
	if in == nil {
		return nil
	}
	out := new(PrioritySelectorRequirement)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceQOSSpec) DeepCopyInto(out *ServiceQOSSpec) {
	*out = *in
	...
	if in.PrioritySelectors != nil {
		...
		*out = make([]PrioritySelectorRequirement, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
