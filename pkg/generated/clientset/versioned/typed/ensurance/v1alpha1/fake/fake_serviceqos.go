...
var serviceqossKind = schema.GroupVersionKind{Group: "ensurance.crane.io", Version: "v1alpha1", Kind: "ServiceQOS"}

// Get takes name of the serviceQOS, and returns the corresponding serviceQOS object, and an error if there is any.
func (c *FakeServiceQOSs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceQOS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(serviceqossResource, name), &v1alpha1.ServiceQOS{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceQOS), err
}
...
func (c *FakeServiceQOSs) Create(ctx context.Context, serviceQOS *v1alpha1.ServiceQOS, opts v1.CreateOptions) (result *v1alpha1.ServiceQOS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(serviceqossResource, serviceQOS), &v1alpha1.ServiceQOS{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceQOS), err
...
func (c *FakeServiceQOSs) Update(ctx context.Context, serviceQOS *v1alpha1.ServiceQOS, opts v1.UpdateOptions) (result *v1alpha1.ServiceQOS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(serviceqossResource, serviceQOS), &v1alpha1.ServiceQOS{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceQOS), err
...
func (c *FakeServiceQOSs) UpdateStatus(ctx context.Context, serviceQOS *v1alpha1.ServiceQOS, opts v1.UpdateOptions) (*v1alpha1.ServiceQOS, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(serviceqossResource, "status", serviceQOS), &v1alpha1.ServiceQOS{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceQOS), err
...
func (c *FakeServiceQOSs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(serviceqossResource, name), &v1alpha1.ServiceQOS{})
	return err
}
...
func (c *FakeServiceQOSs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceQOS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(serviceqossResource, name, pt, data, subresources...), &v1alpha1.ServiceQOS{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServiceQOS), err
